# ArgoWorkflowsClient.Model.IoK8sApiCoreV1PersistentVolumeClaimVolumeSource
...
**VarReadOnly** | **bool** | Will force the ReadOnly setting in VolumeMounts. Default false. | [optional] 
