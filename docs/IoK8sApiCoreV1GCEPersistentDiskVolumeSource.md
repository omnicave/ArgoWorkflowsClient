# ArgoWorkflowsClient.Model.IoK8sApiCoreV1GCEPersistentDiskVolumeSource
...
**VarReadOnly** | **bool** | ReadOnly here will force the ReadOnly setting in VolumeMounts. Defaults to false. More info: https://kubernetes.io/docs/concepts/storage/volumes#gcepersistentdisk | [optional] 
