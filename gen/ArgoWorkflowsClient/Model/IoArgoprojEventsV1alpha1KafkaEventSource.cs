...
namespace ArgoWorkflowsClient.Model
{
    ...
    public partial class IoArgoprojEventsV1alpha1KafkaEventSource : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="config">Yaml format Sarama config for Kafka connection. It follows the struct of sarama.Config. See https://github.com/Shopify/sarama/blob/main/config.go e.g.  consumer:   fetch:     min: 1 net:   MaxOpenRequests: 5  +optional.</param>
        ...
        /// </summary>
        /// <value>Yaml format Sarama config for Kafka connection. It follows the struct of sarama.Config. See https://github.com/Shopify/sarama/blob/main/config.go e.g.  consumer:   fetch:     min: 1 net:   MaxOpenRequests: 5  +optional</value>
